<?php
    ...
    returnWithInfo($firstName, $lastName, $contactID, $email);
    ...
    function returnWithInfo( $first, $last, $contactID, $email )
	{
		$retValue = ["id" => $contactID, "firstName" => $first, "lastName" => $last, "email" => $email, "error" => ""];
		sendResultInfoAsJson($retValue);
	}
